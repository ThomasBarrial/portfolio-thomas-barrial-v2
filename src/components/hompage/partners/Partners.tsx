            ...
            <div ref={ref} className={contentClass}>
                {isAnim && (
                    <div className="w-full text-center ">
                        ...
                        <SlideUp
                            duration={1.8}
                            className="flex flex-col items-center justify-center lg:flex-row  w-full my-10"
                        >
                            {partners.map((item) => (
                                <div
                                    className="lg:w-5/12 flex my-5 px-10 lg:border-r lg:border-l"
                                    key={item.name}
                                >
                                    <Partner item={item} />
                                </div>
                        ...
                        <SlideUp duration={1.5} className="font-poppins mt-2">
                            <button
                                ...
                                className="text-blue text-base underline"
                            >
                                contactUs
                            </button>
                        </SlideUp>
